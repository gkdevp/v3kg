            ...
            <div class="mb-6">
                <div class="items-center justify-between flex mb-3">
                    <div class="flex-col flex">
                        <h3 class="text-xl font-bold">Best Choice</h3>
                        <div class="text-slate-300 text-sm mt-1">The games we think you will like</div>
                    </div>
                ...
                <div class="relative flex overflow-visible">
                    <div class="w-full m-auto">
                        <div class="flex w-full h-full">
                            <swiper :onSwiper="onSwiper" :modules="[SwiperAutoplay]" :rewind="true"
                                :autoplay="{ delay: 70000, pauseOnMouseEnter: true }" :slides-per-view="2"
                                ...
                                <swiper-slide class="py-3" v-for="(slide, index) in contentStore.featuredProviders.slot.new"
                                    :key="index">
                                    <div class="flex-col relative flex w-full h-full mx-auto">
                                        <div class="bg-gray-700 rounded-lg relative">
                                            <img :src="slide.image" :alt="slide.alt"
                                                class="w-full rounded-t-lg transform transition duration-300 ease-in-out"
                                                loading="lazy" />
                                            <div
                                                ...
                                                <button
                                                    ...
                                                    <svg width="22" height="26" viewBox="0 0 22 26" fill="none"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#232939" stroke-width="2.47745" stroke-linecap="round"
                                        ...
                                        <div class="flex items-center bg-gray-700 rounded-b-lg px-3 h-full">
                                            <div class="flex items-center justify-center rounded-2xl">
                                                <img :src="slide.logo" class="w-8" />
                                            </div>
                                            <div class="flex-col flex ml-2 w-full">
                                                <div class="font-bold text-white truncate w-full">
                                                    {{ slide.alt }}
                                                </div>
